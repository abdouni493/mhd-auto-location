      ...
      if (selectedCar) {
        ...
        if (result.success && result.car) {
          const newCar: Car = {
            ...
            priceWeek: Math.round(Number(result.car.price_week || result.car.price_per_day)),
            priceMonth: Math.round(Number(result.car.price_month || result.car.price_per_day)),
