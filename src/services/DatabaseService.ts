...
export class DatabaseService {
  ...
  static async createClient(client: Omit<Client, 'id' | 'createdAt'>): Promise<Client> {
    ...
    const dbClient = {
      ...
      license_expiration_date: client.licenseExpirationDate,
      license_delivery_date: client.licenseDeliveryDate,
      license_delivery_place: client.licenseDeliveryPlace,
      document_type: client.documentType,
      document_number: client.documentNumber,
      document_delivery_date: client.documentDeliveryDate,
      document_expiration_date: client.documentExpirationDate,
